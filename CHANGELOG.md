...
## [0.3.0](https://github.com/woodleighschool/stemma/compare/0.2.1...0.3.0) (2026-09-25)


### ⚠ BREAKING CHANGES

* **lockfile:** version 2 lockfiles are rejected; delete the lockfile and run stemma update.
* **source:** keep fetch state in a disposable source index
...
* **plugin:** describe stages with details ([d89fc9c](https://github.com/woodleighschool/stemma/commit/d89fc9cf7042c68df73233a4520179770f66be7e))
...
* **source:** keep fetch state in a disposable source index ([9be0548](https://github.com/woodleighschool/stemma/commit/9be0548eddfd87948232d75a3bb230d1ffd569cf))
...
* **go:** update module github.com/klauspost/compress (v1.20.0 → v1.20.1) ([#46](https://github.com/woodleighschool/stemma/issues/46)) ([274e5f1](https://github.com/woodleighschool/stemma/commit/274e5f141f665ebe1a40c7c27e6ec89eb8513da1))
...
* **lockfile:** fetch content a refresh named before preparing it ([a59a49e](https://github.com/woodleighschool/stemma/commit/a59a49e3410ad797183fd14c7204d7bf8233b170))
* **lockfile:** version the new entry shape as lockfile version 3 ([4dc8b6d](https://github.com/woodleighschool/stemma/commit/4dc8b6d85a324534019c62294a6a52de0e6f62ac))
...
* **source:** report content a refresh reused as cached ([1baf04f](https://github.com/woodleighschool/stemma/commit/1baf04f3b0b9006f86af9bc91225021cb2dae117))
